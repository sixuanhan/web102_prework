...
const numUnfunded = GAMES_JSON.reduce( (total, game) => {
...
const displayStr = "A total of $" + totalRaised.toLocaleString('en-US') + " has been raised for " + numfunded + 
" games. Currently, " + numUnfunded + (numUnfunded === 1 ? " game remains" : " games remain") + 
...
p.innerHTML = topGame.name;
firstGameContainer.appendChild(p);

// do the same for the runner up item
p = document.createElement("p");
p.innerHTML = runnerUp.name;
